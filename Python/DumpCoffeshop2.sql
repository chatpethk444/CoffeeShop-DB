...
--
-- Table structure for table `departmentphone`
--
...
CREATE TABLE `departmentphone` (
  ...
  CONSTRAINT `departmentphone_ibfk_1` FOREIGN KEY (`DepartmentID`) REFERENCES `department` (`DepartmentID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `departmentphone`
--

LOCK TABLES `departmentphone` WRITE;
/*!40000 ALTER TABLE `departmentphone` DISABLE KEYS */;
/*!40000 ALTER TABLE `departmentphone` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `employee` VALUES ('E0001','Yoon','2004-01-01',NULL,100000.00,'Manager',NULL,'D001'),('E0002','Mos','2004-04-02',NULL,25000.00,'Henchman','E0001','D001'),('E0003','Bart','2003-07-12',NULL,45000.00,'AssistantManager\n','E0001','D001');
...
-- Dump completed on 2025-03-24  2:13:15
